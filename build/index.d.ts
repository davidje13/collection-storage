...
import { encryptByKey, encryptByRecord, encryptByRecordWithMasterKey, EncryptionOptions, Encrypted } from './wrappers/encrypted';
...
export type { DB, Collection, Wrapped, Encryption, Encrypted, EncryptionOptions, Compressed, CompressOptions, };
