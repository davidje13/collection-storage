...
interface RedisWithExtendedPipeline<I> extends Redis {
  ...
  multi(): ChainableCommander & PipelineVersions<I>;
  multi(options: { pipeline: true }): ChainableCommander & PipelineVersions<I>;
  multi(commands?: unknown[][]): ChainableCommander & PipelineVersions<I>;
}
...
export function minifyLuaScript(lines: string[], ...argNames: string[]): string {
